          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.path}>
                  <Link to={link.path} className="text-gray-300 hover:text-secondary-400 transition-colors text-sm flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { name: 'Online Results', path: '/results' },
              ].map((link) => (
                <li key={link.path}>
                  <Link to={link.path} className="text-gray-300 hover:text-secondary-400 transition-colors text-sm flex items-center">
                    <svg className="w-3 h-3 mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-secondary-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"/>
                </svg>
                <span className="text-gray-300 text-sm">{SCHOOL_INFO.address}</span>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">{SCHOOL_INFO.phone}</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-secondary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-300 text-sm">{SCHOOL_INFO.email}</span>
              </li>
            </ul>
          </div>
        </div>
